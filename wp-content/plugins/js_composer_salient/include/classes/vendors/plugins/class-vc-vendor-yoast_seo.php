...
class Vc_Vendor_YoastSeo {
	...
	public function enqueueJs() {
		...
		/* nectar addition - alter version to bust cache */
		wp_enqueue_script( 'vc_vendor_yoast_js', vc_asset_url( 'js/vendors/yoast.js' ), array( 'yoast-seo-post-scraper' ), '6.1.1', true );
	}
