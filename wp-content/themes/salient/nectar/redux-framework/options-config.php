<?php
     ...
     */
     ...
     Redux::setSection( $opt_name, array(
       ...
       'fields'           => array(
         ...
         array(
           ...
           'type'     => 'typography',
           'title'    => esc_html__( 'Off Canvas Navigation Sub Text', 'salient' ),
           'subtitle' => esc_html__( 'Specify the Off Canvas Navigation Sub Text properties.', 'salient' ),
           'google'   => true,
           'all_styles'  => false,
           'fonts' =>  $nectar_std_fonts,
           'default'  => array()
     ...
     Redux::setSection( $opt_name, array(
       'title'            => esc_html__( 'Layout Related', 'salient' ),
       ...
       'fields'           => array(
         ...
         array(
           ...
           'options' => array(
             ...
             'centered-menu-bottom-bar' => array('title' => esc_html__('Centered Menu Bottom Bar','salient'), 'img' => NECTAR_FRAMEWORK_DIRECTORY.'options/img/centered-menu-bottom-bar.png', 'tooltip' => 'Relies on the <b>&quot;Material&quot;</b> theme skin and will use that option even if not selected. <br/><br/> Top left: Social Icon Area <br/> Top right: Header Buttons <br/> Bottom: Navigation Links'),
             'centered-logo-between-menu' => array('title' => esc_html__('Centered Logo Between Menu','salient'), 'img' => NECTAR_FRAMEWORK_DIRECTORY.'options/img/centered-logo-menu.png'),
     ...
     Redux::setSection( $opt_name, array(
       'title'            => esc_html__( 'Off Canvas Menu/Mobile Menu', 'salient' ),
     ...
     Redux::setSection( $opt_name, array(
       ...
       if ($woocommerce) {
         ...
         Redux::setSection( $opt_name, array(
           ...
           'id'               => 'woocommerce',
           'desc'             => esc_html__( 'All WooCommerce related options are listed here', 'salient' ),
           'customizer_width' => '400px',
           ...
           'fields' => array(
             ...
             array(
               ...
               'desc' => '',
               'options' => array(
                 "dropdown" => esc_html__("Dropdown", "salient"),
                 "slide_in" => esc_html__("Slide In Full Page Height", "salient")
               ),
               'default' => 'dropdown',
